  ...
  <Layout>
    <Events>
      ...
      <ul>
        ...
        <li>
          <a href="http://soundcloud.com/bklxa">Bakläxa</a>
        </li>
        <li>
          <a href="http://soundcloud.com/198319831983">1983</a>
        </li>
        <li>
          <a href="http://soundcloud.com/cp-ak">CP-AK</a>
        </li>
      </ul>
      <Location>
        Where:
        <a href="https://maze.berlin">maze berlin</a> (Mehringdamm 61)
      </Location>
      <Time>When: 22:00+</Time>
      <p>
        join us on
        <a href="https://www.residentadvisor.net/events/1157178">
          Resident Advisor
        </a>{" "}
        or

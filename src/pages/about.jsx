...
export default () => (
  ...
  <div style={{ margin: '1.6rem 1.2rem', maxWidth: 600 }}>
    ...
    <p>
      { /* eslint-disable-next-line max-len */ }
      CP-AK is a DJ and music enthusiast from Buenos Aires, Argentina. Born to a 2nd generation Slovenian family. After moving to Europe in his 2010, he eventually settled in Ljubljana, Slovenia. He got involved in the local electronic music scene and soon started working as a member of the music editorial in Slovenia&rsquo;s cult Radio Student, one of Europe’s oldest and strongest independent and non-commercial urban radio stations. He soon started performing as a DJ, recording podcasts and playing at selected venues in Ljubljana. Co-created the
      {' '}
      <a href="pelje.com">Pelje</a>
      {' '}
music blog in 2014 with
      {' '}
      <a href="http://sepic.cc/">Tilen Sepic</a>
, industrial designer and creative. Co-founded Imaginary Radio Stations in Berlin (2017).
    </p>
    <ul>
    ...
    <p>
      { /* eslint-disable-next-line max-len */ }
      Evano has released his music on Archipel, PHI, Pluie/Noir, Colours Music, Škuc Ventilator and Založba Radia Študent. He produced music and sound collages for Slovenian Theater Mladinsko in 2015 and ACUD Theater Berlin in 2016. His interest in sound collage, and music for theatre and dance performance, has recently found a home under the project
      {' '}
      <a href="https://soundcloud.com/amolab/">AMOLAB</a>
. Co-founded Imaginary Radio Stations in Berlin (2017).
    </p>
    <p>
      { /* eslint-disable-next-line max-len */ }
    ...
    <ul>
      ...
      <li><a href="https://www.discogs.com/artist/878602-1983">discogs</a></li>
